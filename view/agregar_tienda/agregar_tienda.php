...
<!--         <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="password" class="form-control" id="password" name="pass" placeholder="Contraseña de Tienda" required>
        </div>
...
<?php
    $script_dir = 'agregar_tienda';
    $script_file = 'agregar_tienda.js';
